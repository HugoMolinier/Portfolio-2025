  ...
  return (
    <main>
      <section id="introduction">
        <p>
          Dans le cadre de ma 3ᵉ année de BUT Informatique, nous avons
          travaillé, en équipe de 6 puis 8 personnes, sur un projet complet
          visant à faciliter les trajets multimodaux pour les personnes à
          mobilité réduite (PMR) et à fournir aux agents un outil de suivi en
          temps réel.
        </p>
        ...
        <ul>
          ...
          <li>
            <strong>Semestre 2</strong> : changement d’équipe, prise en main
            d’un back-end différent pour assurer sa maintenance, y apporter des
      ...
      <section id="decouverte" style={sectionStyle}>
        ...
        <p>
          Durant le cinquième semestre, j’ai intégré une équipe pour concevoir
          et développer le backend, en participant aussi aux décisions
          techniques pour le front.
        </p>
        <ul>
          <li>
        ...
        <ul>
          ...
          <li>
            Préparer et présenter les user stories aux membres de l’équipe et à
            la MOA.
          </li>
          <li>
            Planifier les objectifs de sprint et animer les rituels agiles
      ...
      <section id="missions" style={sectionStyle}>
        ...
        <article>
          <p>
            ...
            controllers. J’ai développé des services REST couvrant les
            principaux domaines fonctionnels du projet : gestion des
            utilisateurs, réservations, voyages, authentification biométrique,
            suivi des bagages, notifications et assistance PMR. Mon travail a
          ...
          <p>
            ...
            modèles Node.js afin de gérer efficacement les informations liées
            aux PMR et à leurs trajets multimodaux. Les données sensibles et
          ...
          <p>
            ...
            externes (pour ce projet, nous avons simulé ces bases pour des
            raisons budgétaires) :
          </p>
          <ul>
            <li>Air France</li>
          ...
          <p>
            Pour uniformiser les échanges entre ces différentes bases, nous
            avons utilisé le format Amadeus, le standard officiel de l’industrie
            du voyage.
          </p>
        ...
        <article>
          ...
          <ul>
            <li>
              <strong>Middleware d’authentification</strong> : gestion des
              tokens pour vérifier que chaque requête provient d’un utilisateur
              autorisé.
            </li>
            <li>
            ...
            <li>
              <strong>Middleware d’erreurs</strong> : uniformisation des
              réponses API et traitement centralisé des exceptions, pour
              améliorer la lisibilité et la fiabilité des retours.
            </li>
          </ul>
          <p>
            Cela a renforcé la sécurité et la fiabilité du backend, tout en
            facilitant l’extension des fonctionnalités et la maintenance du
            code. Une fois fait, il a fallu ajouter ce middlewares à chaque
            route.
          </p>
        </article>
        <article>
        ...
        <p>
          Au cours de ce semestre,de janvier à mi-mars, j’ai dû changer de
          groupe conformément aux consignes, ce qui m’a demandé une forte
          capacité d’adaptation. J’ai pris en charge la maintenance d’un backend
          existant, développé par un autre groupe, ce qui impliquait de
          comprendre rapidement une architecture et un code qui n’étaient pas
          les miens, et d’apporter des corrections et améliorations tout en
          respectant la structure initiale.Ma tache à été la maintenance du
          backend et le le développement de l’APK mobile.
        </p>
        <br />
        <p>
          Contrairement à mon ancien groupe, celui-ci avait tout mis en place
          avec Docker, ce qui m’a permis d’acquérir de nouvelles compétences en
          conteneurisation et déploiement, ainsi que de découvrir une autre
        ...
        <p>
          Pour générer l’APK, j’ai d’abord réglé les dépendances dans
          package.json afin d’intégrer Expo, React Native et les modules
          essentiels comme la carte, le QR code, la caméra ou le stockage. J’ai
          ensuite corrigé les problèmes spécifiques rencontrés, assurant ainsi
          le bon fonctionnement de l’application et la génération réussie de
          l’APK. Pour avoir enfin le .apk j'ai utilisé EAS (Expo Application
          Services) pour compiler et générer l’APK de manière fiable.
        </p>
      </section>
      <section id="resultats" style={sectionStyle}>
        <header style={{ marginBottom: 20 }}>
          <h2>Résultats</h2>
        </header>
        <p>
        ...
        <p>
          ...
          solution et son architecture, et de recueillir des retours pour
      ...
      <section id="apprentissage" style={sectionStyle}>
        ...
        <p>
          ...
          génération d’APK, Docker pour la conteneurisation et le déploiement),
          ce projet m’a surtout permis de mieux comprendre la distinction entre
          la MOA (Maîtrise d’Ouvrage) et la MOE (Maîtrise d’Œuvre), ainsi que la
          manière dont elles interagissent dans la gestion de projet. Nous avons
          également appris à préparer et réaliser une présentation type salon,
          en valorisant le projet comme un produit destiné à être exposé et
          présenté à des acteurs extérieurs.
        </p>
        ...
        <p>
          ...
          permis d’acquérir une expérience complète sur l’ensemble du cycle de
          vie d’un projet informatique, de la conception au déploiement, en
          passant par la maintenance. J’ai consolidé mes compétences techniques,
          notamment sur Node.js, MongoDB, SQL, React Native, Expo, Docker et
          Kafka, tout en développant une compréhension approfondie des
          architectures backend et des flux de données complexes.
        </p>
        <br />
        <p>
